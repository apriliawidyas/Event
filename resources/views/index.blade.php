            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <h2 class="text-uppercase">Steroids 2018</h2>
                  <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                  <img class="img-fluid d-block mx-auto" src="img/portfolio/01-full.jpg" alt="">
                  <p>Steroids adalah charity concert tahunan yang bertujuan untuk menyuarakan penanggulangan dan bahaya HIV/AIDS dengan menampilkan musisi2 ternama dalam negeri. Diharapkan kampanye akan tersampaikan dengan baik dan menarik kepada seluruh kalangan masyarakat Bandung dan sekitarnya..Present By @againstaids. On November 24th 2018.SAVE YOUR TICKETS NOW! </p>
                  <ul class="list-inline">
                    <li>Date: 24 November 2018</li>
